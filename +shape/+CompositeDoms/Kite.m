classdef Kite< shape.C2boundary
    ...
    methods
      function obj = Kite(a,nbPoints,dspl)  
            if nargin < 3
               dspl = 1 ; 
            end            
            k = 4 ;
            ...
            edge2  = a*(([0;-1] - [-1;0])*selector2 + [-1;0])  ;
            edge3  = a*(([1;0] - [0;-1])*selector2 + [0;-1]) ;
            ...
            obj = obj@shape.C2boundary(points, tvec, avec, normal, [0;0], 'Kite');
